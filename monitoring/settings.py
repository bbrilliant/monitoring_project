...
EMAIL_HOST_USER = env('EMAIL_HOST_USER', default='noreply.atos.dev@gmail.com')
EMAIL_HOST_PASSWORD = env('EMAIL_HOST_PASSWORD', default='fgdasnfvnitrlaiy')
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='API Monitor <noreply.atos.dev@gmail.com>')
